...
class AddForignKeysToAppointmentTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('appointment', function (Blueprint $table) {
            //
            $table->foreign('doctor_id', 'fk_appointment_to_specialist')->references('id')->on('specialist')->onUpdate('cascade')->onDelete('cascade');
    ...
    public function down()
    {
        Schema::table('appointment', function (Blueprint $table) {
            //
            $table->dropForeign('fk_appointment_to_specialist');
